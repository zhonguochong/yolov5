...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default='data/hjd.yaml', help='data.yaml path')
    ...
    parser.add_argument('--noautoanchor', action='store_true', help='disable autoanchor check')  # 自适应的计算不同训练集中的最佳锚框值
